/* PULIRA · capa única de analítica: Meta Pixel + GA4 + Supabase (leads y eventos) con event_id compartido para deduplicar con la CAPI.
...
(function () {
  ...
  var META = { diag_complete: 'Lead', lead: 'Lead', add_to_cart: 'AddToCart', kit_cta_click: 'InitiateCheckout', checkout_whatsapp: 'InitiateCheckout', purchase: 'Purchase' }; // evento estándar de Meta que dispara cada evento propio
